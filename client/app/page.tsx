            ...
            {showModal && (
              <div className="h-full fixed left-0 top-0 z-modal flex w-full overflow-hidden overscroll-none">
                ...
                <button
                  onClick={() => setShowModal(false)}
                  aria-label="閉じる"
                  className="absolute top-6 right-6 z-1 grid aspect-square w-8 place-items-center rounded-full bg-[#a7abb1] text-white hover:bg-main-500 motion-safe:animate-fadeIn xs:top-8 xs:right-8"
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                  ...
                  <div className="px-6 py-12 sm:px-10">
                    <div>
                      <a className="flex flex-col items-center" href="/home">
                        <div className="mt-2.5 text-xl motion-safe:animate-fadeInSlow">
                          協力隊の輪
                        </div>
                      </a>
                      <p className="mt-5 text-sm leading-relaxed text-main-700">
                        協力隊のOBOGのためのサービスです。
                      </p>
                      <div className="mt-7">
                        <button
